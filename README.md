...
1. **Engineer pastes logs** → Agent triggers `log-parser` skill
...
4. Test with real incident scenarios
...
- Check the [common-errors.md](skills/log-parser/references/common-errors.md) reference
- Review the [references](skills/incident-brief-summarizer/references/) for examples
